...
HOME_CONFIG = os.path.isfile(
    os.path.join(os.path.dirname(os.path.abspath(__file__)), ".HOMEDIR")
)
...
try:
    ...
    print(
        "Environment variable CALIBRE_PORT has invalid value (%s), faling back to default (8083)"
        % env_CALIBRE_PORT
    )
...
SUPPORTED_CALIBRE_BINARIES = {
    binary: binary + _extension for binary in ["ebook-convert", "calibredb"]
}
